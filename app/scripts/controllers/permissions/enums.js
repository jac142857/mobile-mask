...
export const NOTIFICATION_NAMES = {
  accountsChanged: 'mobilemask_accountsChanged',
  unlockStateChanged: 'mobilemask_unlockStateChanged',
  chainChanged: 'mobilemask_chainChanged',
};
...
export const SAFE_METHODS = [
  ...
  'eth_syncing',
  'eth_uninstallFilter',
  'mobilemask_getProviderState',
  'mobilemask_watchAsset',
  'net_listening',
  'net_peerCount',
  'net_version',
  'personal_ecRecover',
