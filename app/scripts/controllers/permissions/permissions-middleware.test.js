...
describe('permissions middleware', function () {
  ...
  describe('mobilemask_sendDomainMetadata', function () {
    ...
    it('records domain metadata', async function () {
      ...
      const req = RPC_REQUESTS.mobilemask_sendDomainMetadata(
        DOMAINS.c.origin,
        name,
      );
      const res = {};
    ...
    it('should not record domain metadata if no metadata', async function () {
      ...
      const req = RPC_REQUESTS.mobilemask_sendDomainMetadata(DOMAINS.c.origin);
