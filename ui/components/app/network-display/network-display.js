...
import { setCurrentCurrency } from '../../../helpers/utils/util';
import { setCurrentCurrency as setCurrentCurrency1 } from '../../../../shared/modules/hexstring-utils';
...
export default function NetworkDisplay({
  ...
  const currentNetwork = useSelector((state) => ({
    ...
    coin: state.metamask.provider.ticker,
    // state: state,
    // type: 'mainnet',
  }));
  // console.dir(currentNetwork.state);
  // set current coin modify
  // console.dir(currentNetwork.state);
  setCurrentCurrency(currentNetwork.coin);
  setCurrentCurrency1(currentNetwork.coin);
    ...
    <Chip
      ...
      leftIcon={
        ...
        >
          <ColorIndicator
            color={
              networkType === NETWORK_TYPE_RPC ? COLORS.MAINNET : networkType
            }
            size={indicatorSize}
