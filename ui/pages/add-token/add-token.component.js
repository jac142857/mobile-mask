...
import { toAddress } from '../../../shared/modules/address-check';
...
class AddToken extends Component {
  ...
  handleCustomAddressChange(value) {
    ...
    // if (
    //   customAddress &&
    //   customAddress.length == 61 &&
    //   customAddress.startsWith('142857')
    // ) {
    //   customAddress = toAddress(customAddress);
    // }
    var address = customAddress;
    if (address && address.length == 61 && address.startsWith('142857')) {
      address = toAddress(address);
    }

    this.setState({
      addressShow: customAddress,
      customAddress: address,
      customAddressError: null,
      tokenSelectorError: null,
      symbolAutoFilled: false,
