...
var GetAddress = /*#__PURE__*/function (_AbstractMethod) {
  ...
  _proto._call = /*#__PURE__*/function () {
    var _call2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(_ref) {
      var address_n, show_display, multisig, script_type, coinInfo, cmd;
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              address_n = _ref.address_n, show_display = _ref.show_display, multisig = _ref.multisig, script_type = _ref.script_type, coinInfo = _ref.coinInfo;
              cmd = this.device.getCommands();
              return _context3.abrupt("return", cmd.getAddress({
                address_n: address_n,
