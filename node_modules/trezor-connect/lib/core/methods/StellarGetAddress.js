...
var StellarGetAddress = /*#__PURE__*/function (_AbstractMethod) {
  ...
  function StellarGetAddress(message) {
    ...
    if (_this.params.length === 1) {
      _this.info = "Export Stellar address for account #" + ((0, _pathUtils.fromHardened)(_this.params[0].address_n[2]) + 1);
    } else {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return cmd.typedCall('StellarGetAddress', 'StellarAddress', {
                address_n: address_n,
