...
var ComposeTransaction = /*#__PURE__*/function (_AbstractMethod) {
  ...
  _proto.precompose = /*#__PURE__*/function () {
    var _precompose = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(account, feeLevels) {
      var _this$params, coinInfo, outputs, baseFee, address_n, segwit, composer, blockchain;

      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$params = this.params, coinInfo = _this$params.coinInfo, outputs = _this$params.outputs, baseFee = _this$params.baseFee;
              address_n = pathUtils.validatePath(account.path);
              segwit = pathUtils.isSegwitPath(address_n) || pathUtils.isBech32Path(address_n);
