...
var NEMGetAddress = /*#__PURE__*/function (_AbstractMethod) {
  ...
  function NEMGetAddress(message) {
    ...
    if (_this.params.length === 1) {
      ...
      _this.info = "Export NEM address for account #" + ((0, _pathUtils.fromHardened)(_this.params[0].address_n[2]) + 1) + " on " + network + " network";
    } else {
  ...
  _proto._call = /*#__PURE__*/function () {
    var _call2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(_ref) {
      var address_n, network, show_display, cmd, response;
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              address_n = _ref.address_n, network = _ref.network, show_display = _ref.show_display;
              cmd = this.device.getCommands();
              _context3.next = 4;
              return cmd.typedCall('NEMGetAddress', 'NEMAddress', {
                address_n: address_n,
                network: network,
