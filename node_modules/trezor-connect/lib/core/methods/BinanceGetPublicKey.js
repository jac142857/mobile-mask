          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              if (this.params.length > 1) {
                ...
                label = "Export Binance public key for account #" + ((0, _pathUtils.fromHardened)(this.params[0].address_n[2]) + 1);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              batch = this.params[i];
              _context2.next = 7;
              return cmd.typedCall('BinanceGetPublicKey', 'BinancePublicKey', batch);
