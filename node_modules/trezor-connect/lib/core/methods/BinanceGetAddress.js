...
var BinanceGetAddress = /*#__PURE__*/function (_AbstractMethod) {
  ...
  function BinanceGetAddress(message) {
    ...
    if (_this.params.length === 1) {
      _this.info = "Export Binance address for account #" + ((0, _pathUtils.fromHardened)(_this.params[0].address_n[2]) + 1);
    } else {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return cmd.typedCall('BinanceGetAddress', 'BinanceAddress', {
                address_n: address_n,
