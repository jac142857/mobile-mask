...
var CardanoGetAddress = /*#__PURE__*/function (_AbstractMethod) {
  ...
  function CardanoGetAddress(message) {
    ...
    if (_this.params.length === 1) {
      _this.info = "Export Cardano address for account #" + ((0, _pathUtils.fromHardened)(_this.params[0].address_parameters.address_n[2]) + 1);
    } else {
  ...
  _proto._call = /*#__PURE__*/function () {
    var _call2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(_ref) {
      var address_parameters, protocol_magic, network_id, show_display, cmd, response;
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              address_parameters = _ref.address_parameters, protocol_magic = _ref.protocol_magic, network_id = _ref.network_id, show_display = _ref.show_display;
